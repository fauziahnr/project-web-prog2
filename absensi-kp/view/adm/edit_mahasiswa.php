<?php 
    ...
    if ($get_sw = $conn->query($sql_sw)->fetch(PDO::FETCH_ASSOC)) {
    extract($get_sw);
    ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" value="<?php echo $nis_user; ?>" class="form-control" name="nis" placeholder="Masukan NIM" required>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" value="<?php echo $sklh_user; ?>" class="form-control" name="sklh" placeholder="Masukan Nama Univ" required>
    </div>
  </div>
  <div class="form-group">
