...
(49, 2, 7, 2, 10, 'cek catatan\r\nasdas\r\nasddwa\r\n1e1\r\nadadasd\r\nqesad\r\nawdwd', 'Dikonfirmasi'),
(50, 2, 11, 2, 6, 'wkwkkwk\r\nanyarr keehhhh', 'Dikonfirmasi'),
(52, 2, 11, 2, 6, 'ihirrrrtes tes', 'Ditolak');
...
(81, '2', 11, 2, 6, '03.37 WIB', 'Dikonfirmasi', '03.38 WIB', 'Dikonfirmasi');
...
(2, 16090157, 'qodim ibnu salam aw', 'Politeknik Harapan Bersama', 'L');
...
INSERT INTO `user` (`id_user`, `username`, `pwd_user`, `level_user`) VALUES
(2, 'qodim@gmail.com', '8cb2237d0679ca88db6464eac60da96345513964', 'sw'),
(1, 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'pb');
...
--
ALTER TABLE `catatan`
  MODIFY `id_cat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
